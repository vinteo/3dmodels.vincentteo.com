import { draw, drawPolysides, Drawing, AnyShape } from 'replicad';
import { ParameterDefinition, ParameterOption } from '../../../types/model';
import { extractDefaultParameters, type ReplicadPart } from '../types';
 ...
 */
export function buildKumikoHexCellParts(
  params: KumikoParameters,
  singlePartOverride?: boolean
): ReplicadPart[] {
